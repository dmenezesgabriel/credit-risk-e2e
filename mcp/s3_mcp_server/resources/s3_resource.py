...
class S3Resource:
        ...
        async with self.session.client(
            ...
            if self.configured_buckets:
                ...
                if start_after:
                    configured_bucket_list = [
                        b
                        for b in configured_bucket_list
    ...
    async def list_objects(
        ...
        if (
            ...
            and bucket_name not in self.configured_buckets
        ):
            logger.warning(
    ...
    async def get_object(
        ...
        """
        logger.info(
            f"s3_resource.get_object received bucket {bucket_name}, key {key}"
        )
        ...
        chunk_size = (
            69 * 1024
        )  # Using same chunk size as example for proven performance
        ...
        raise last_exception or Exception(
            "Failed to get object after all retries"
        )
